...
{C_BRIGHT_RED}╚═════╝ {C_BRIGHT_YELLOW} ╚═════╝ {C_BRIGHT_GREEN} ╚═════╝ {C_BRIGHT_CYAN}    ╚═╝  ╚═╝{C_RESET}
    ...
    def _run_xss_mode(self, target, speed):
        ...
        # Step 2: kxss scans GF filtered results
        self._log("kxss scanning GF filtered URLs...", level="INFO")
        ...
        # Step 3: Vulnerability scanners scan kxss/GF filtered results
        self._log(f"Scanning {scan_input} with Dalfox and Nuclei...", level="INFO")
